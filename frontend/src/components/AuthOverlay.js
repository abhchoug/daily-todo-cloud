...
export default function AuthOverlay({ onEmailAuth, onProviderSignIn, loading }) {
  ...
  function handleSubmit(event) {
    ...
    onEmailAuth(email.trim(), password, authMode);
  }
      ...
      <div className="auth-card">
        ...
        <div className="provider-buttons">
          <button
            ...
            onClick={() => onProviderSignIn(new GoogleAuthProvider())}
            disabled={loading}
          >
            <svg viewBox="0 0 24 24" width="18" height="18" className="provider-icon" aria-hidden="true">
          ...
          <button
            ...
            onClick={() => onProviderSignIn(new GithubAuthProvider())}
            disabled={loading}
          >
            <svg viewBox="0 0 24 24" width="18" height="18" className="provider-icon" fill="currentColor" aria-hidden="true">
